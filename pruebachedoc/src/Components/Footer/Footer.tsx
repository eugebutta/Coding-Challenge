...
function Footer() {
  return (
    <div className="containerFooter">
      ...
      <div className="containerFooterCopyright">
        <span className="footerCopyright">© Copyright 2021 Challenge</span>
      </div>
      <div className="conteinerIcons">
        ...
        <div className="storeIcon">
          ...
          <svg xmlns="http://www.w3.org/2000/svg"  height="40.019"
            width="135.716" viewBox="0 0 864 312">
